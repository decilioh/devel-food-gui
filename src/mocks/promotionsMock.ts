export const PromotionsMock = [
    ...
    {
        promotionName: "Dinner Time Special",
    ...
    {
        promotionName: "Thanksgiving Feast",
    ...
    {
        promotionName: "Cyber Monday Offer",
